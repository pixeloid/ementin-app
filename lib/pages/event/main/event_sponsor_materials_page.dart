...
import 'package:ementin_flutter/models/sponsor.dart';
...
class SponsorMaterialsPage extends StatelessWidget with HeaderDelegate {
  ...
  const SponsorMaterialsPage({super.key, required this.sponsor});
...
class SponsorMaterialsViewer extends StatefulWidget {
  ...
  const SponsorMaterialsViewer({required this.sponsor, super.key});
