...
import '../pages/auth/auth_page.dart' as _i6;
import '../pages/checkin_page.dart' as _i5;
import '../pages/event/event_main_page.dart' as _i3;
import '../pages/event/main/event_info_page.dart' as _i7;
import '../pages/event/main/event_program_page.dart' as _i8;
...
class AppRouter extends _i9.RootStackRouter {
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    CheckInRoute.name: (routeData) {
      return _i9.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i5.CheckInPage());
    },
    ...
    EventInfoRoute.name: (routeData) {
      return _i9.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.EventInfoPage());
    },
    EventProgramRoute.name: (routeData) {
      return _i9.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.EventProgramPage());
    }
  };
  ...
  List<_i9.RouteConfig> get routes => [
        ...
        _i9.RouteConfig(EventListRoute.name, path: '/events'),
        _i9.RouteConfig(MainRoute.name, path: '/main', children: [
          _i9.RouteConfig(EventMainRoute.name,
              path: 'event',
              parent: MainRoute.name,
              children: [
                _i9.RouteConfig(EventInfoRoute.name,
                    path: 'info', parent: EventMainRoute.name),
                _i9.RouteConfig(EventProgramRoute.name,
                    path: 'program', parent: EventMainRoute.name)
              ]),
          _i9.RouteConfig(ProfileRoute.name,
              path: 'profile', parent: MainRoute.name),
          _i9.RouteConfig(CheckInRoute.name,
              path: 'check-in', parent: MainRoute.name),
          _i9.RouteConfig(AuthRoute.name, path: 'auth', parent: MainRoute.name)
        ])
      ];
}
...
/// generated route for
/// [_i3.EventMainPage]
class EventMainRoute extends _i9.PageRouteInfo<void> {
  const EventMainRoute({List<_i9.PageRouteInfo>? children})
...
/// generated route for
/// [_i5.CheckInPage]
class CheckInRoute extends _i9.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.EventInfoPage]
class EventInfoRoute extends _i9.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.EventProgramPage]
class EventProgramRoute extends _i9.PageRouteInfo<void> {
